---
title: "C°F 5th Weather Chart - Lifestyle (NL, Friesland, Groningen, Drenthe) Analysis"
...
- When the response of a question was qualitative, they were converted to a numeric scale. 
For example, if the question was 'how often did you eat ice-cream in the past 4 weeks?', the type of responses were '1-2 days' or '2 days per week'. In this case, the first one would be converted to `1/28` and the second one to `2*4/28`. 
